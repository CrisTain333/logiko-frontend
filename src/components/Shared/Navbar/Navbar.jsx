          ...
          <div className="navbar-start">
            <div className=" flex items-center">
              ...
              <div className="flex-1">
                <img className="h-14 lg:h-20 w-auto" src={logo} alt="" />
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative w-[38rem]">
                ...
                <input
                  type="text"
                  id="simple-search"
                  className="text-sm rounded-full block w-full pl-10 p-2.5 bg-info focus:border-none focus:outline-none"
          ...
          <div className="navbar-end">
            <div className="space-x-8 flex items-center">
              <div className="relative">
                ...
                <img
                  className="w-3 h-3 absolute top-[-5px] right-[-5px]"
                  src={dot}
                  alt=""
                />
              </div>
