...
const Navbar = () => {
  ...
  return (
    <div className="bg-base-200 min-h-[4.5rem] flex items-center">
      <>
          ...
          <div className="col-span-9 flex items-center justify-between">
            <div>
              ...
              <div class="relative w-[38rem]">
                ...
                <input
                  type="text"
                  id="simple-search"
                  class="text-sm rounded-full block w-full pl-10 p-2.5 bg-info focus:border-none focus:outline-none"
            ...
            <div className="space-x-8 flex items-center">
              <div className="relative">
                ...
                <img className="w-3 h-3 absolute top-[-5px] right-[-5px]" src={dot} alt="" />
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
